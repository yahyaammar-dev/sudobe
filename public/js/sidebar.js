...
const sidebarMenuItems = [
  { href: `${window.BASE_PATH}/api/content?section=banners-list`, icon: 'bi-inbox', label: 'Banners', id: 'banners', permission: 'view_banners' },
  { href: `${window.BASE_PATH}/api/content?section=protections-list`, icon: 'bi-shield-check', label: 'Protections', id: 'protections', permission: 'view_protections' },
  { href: `${window.BASE_PATH}/api/content?section=images-list`, icon: 'bi-image', label: 'Images', id: 'images', permission: 'view_images' },
  { href: `${window.BASE_PATH}/api/content?section=products`, icon: 'bi-cart', label: 'Products Import Export', id: 'products-import', permission: ['import_products', 'export_products'] },
  { href: `${window.BASE_PATH}/api/content?section=products-list`, icon: 'bi-cart', label: 'Products', id: 'products-list', permission: 'view_products' },
  { href: `${window.BASE_PATH}/qa`, icon: 'bi-clipboard-check', label: 'QC Reports', id: 'qa', permission: 'view_qa_reports' },
  { href: `${window.BASE_PATH}/shipping-rates`, icon: 'bi-truck', label: 'Shipping Rates', id: 'shipping-rates', permission: 'view_shipping_rates' },
  { href: `${window.BASE_PATH}/customers`, icon: 'bi-people', label: 'Customers', id: 'customers', permission: 'view_customers' },
  { href: `${window.BASE_PATH}/factories`, icon: 'bi-building', label: 'Factories', id: 'factories', permission: 'view_factories' },
  { href: `${window.BASE_PATH}/orders`, icon: 'bi-receipt', label: 'Orders', id: 'orders', permission: 'view_orders' },
  { href: `${window.BASE_PATH}/logs`, icon: 'bi-clock-history', label: 'Activity Logs', id: 'logs', permission: 'view_logs' },
  { href: `${window.BASE_PATH}/permissions`, icon: 'bi-shield-lock', label: 'Permissions & Roles', id: 'permissions', permission: 'manage_roles' }
];
...
async function loadUserPermissions() {
  try {
    const response = await fetch(`${window.BASE_PATH}/api/auth/me`);
    if (response.ok) {
